  ...
  return (
    ...
    >
      ...
      <Box
        ...
        padding={{ base: "20px 20px 20px 20px", md: "40px 66px 40px 66px" }}
      >
        <Heading
          as="h1"
          fontWeight={"800"}
      ...
      <Box
        ...
        alignItems={"left"}
        height={"100%"}
        margin={{ base: "20px 20px 20px 20px", md: "0px 66px 78px 66px" }}
        padding={{ base: "20px 20px 20px 20px", lg: "70px 0 0 43px" }}
        ...
        >
          <Input
            ...
            {...register("class", {
              ...
              maxLength: {
                value: 10,
                message: "A turma deve possuir, no máximo, 10 caracteres!"
              }
            })
            }
            variant="subtle"

...
export default function RegisterStudent({credentialUser, setCredentialUser, alertMessageData, setAlertMessageData, changeAlertVisibility}: CredentialUserProps) {
  return (
